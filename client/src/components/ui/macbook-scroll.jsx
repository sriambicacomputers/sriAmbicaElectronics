...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(scrollYProgress, [0, 0.3], [1.2, isMobile ? 1.2 : 1.5]);
  const scaleY = useTransform(scrollYProgress, [0, 0.3], [0.6, isMobile ? 1.2 : 1.5]);
  ...
  return (
    ...
    <div
      ref={ref}
      className="flex min-h-[10dvh] md:min-h-[150dvh] shrink-0 scale-[0.5] transform flex-col items-center justify-start relative -top-10 py-20 [perspective:800px] sm:scale-100  md:py-70">
      ...
      <Lid
        ...
        translate={translate} />
      <div
        className="relative -z-10 h-[22rem] w-[32rem] overflow-hidden rounded-2xl bg-[#1C1C1C] dark:bg-[#B0B0B0]">

        <div className="relative h-10 w-full">
          <div className="absolute inset-x-0 mx-auto h-4 w-[80%] bg-[#050505]" />
        </div>

        <div className="relative px-[1.5px] flex">
    ...
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        <img
          src={src}
          alt="awef"
          className="absolute inset-0 h-full w-full rounded-lg object-contain brightness-90 object-left-top" />
      </motion.div>
    </div>
  );
};
